...
// Country centroids used to place HAPI country aggregates on the globe.
// Coordinates are public-domain geographic approximations (Natural Earth
// / common atlas centres), not a vendor of any third-party dashboard.
