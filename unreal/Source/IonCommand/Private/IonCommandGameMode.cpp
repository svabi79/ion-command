...
void AIonCommandGameMode::BeginPlay()
{
    ...
    // The diegetic deck (floating title + three data console panels) is placed
    // in the level; it hides itself in BeginPlay unless -IonShowDeck is set,
    // which also covers this fallback spawn.
