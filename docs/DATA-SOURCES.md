...
| **IMF PortWatch** | Maritime chokepoint locations and daily transit counts from the IMF PortWatch public ArcGIS FeatureServer. | [portwatch.imf.org](https://portwatch.imf.org) |
...
| `maritime.portwatch` | IMF PortWatch ArcGIS FeatureServer | 21600 s | `maritime.chokepoint` | yes |
